...
export const SEED_COMBOS: SeedCombo[] = [
  {
    ...
    description: "1 roll a elección (8 piezas) + guarnición + bebida",
    price: 7500,
    is_available: true,
  ...
  },
  {
    ...
    name: "Combo Pareja",
    description: "2 rolls a elección + guarnición grande + 2 bebidas",
    price: 14500,
    is_available: true,
    created_at: "2025-01-01T00:00:00Z",
  },
  {
    ...
    name: "Combo Deluxe",
    description: "Roll especial + guarnición premium + bebida",
    price: 9200,
    is_available: true,
    created_at: "2025-01-01T00:00:00Z",
  },
